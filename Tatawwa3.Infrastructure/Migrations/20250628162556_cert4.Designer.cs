...
namespace Tatawwa3.Infrastructure.Migrations
{
    ...
    [Migration("20250628162556_cert4")]
    partial class cert4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            City = "Cairo",
                            ConcurrencyStamp = "12a7ba91-9c96-4671-8346-da40279ad9a8",
                            CreatedAt = new DateTime(2025, 6, 28, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(2969),
                            ...
                            Role = 1,
                            SecurityStamp = "67e75aef-ee45-4376-87e1-b6787dc04999",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            City = "Assiut",
                            ConcurrencyStamp = "675d8e59-8e76-438d-bbc9-e092e12d0c61",
                            CreatedAt = new DateTime(2025, 6, 28, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3155),
                            ...
                            PhoneNumberConfirmed = false,
                            Role = 0,
                            SecurityStamp = "14ab0558-19ba-4877-b678-7ed5e6597632",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 28, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3334),
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.OrganizationProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 28, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3079),
                            IsDeleted = false,
                            IsVerified = true,
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.Team", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Cairo",
                            CreatedAt = new DateTime(2025, 6, 28, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3507),
                            CreationDate = new DateTime(2025, 6, 13, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3496),
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.TeamMember", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "member-1",
                            CreatedAt = new DateTime(2025, 6, 28, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3572),
                            IsDeleted = false,
                            JoinDate = new DateTime(2025, 6, 23, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3570),
                            Role = "Leader",
                            TeamID = "team-1",
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.VolunteerOpportunity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "opp-1",
                            CategoryID = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 28, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3633),
                            Description = "Help young children learn basic English skills.",
                            EndDate = new DateTime(2025, 8, 7, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3630),
                            Image = "english-teaching.png",
                            IsDeleted = false,
                            Location = "Cairo",
                            OrganizationID = "org-user-1",
                            RequiredVolunteers = 10,
                            StartDate = new DateTime(2025, 7, 8, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3629),
                            Status = 1,
                        ...
                        new
                        {
                            Id = "opp-2",
                            CategoryID = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 28, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3640),
                            Description = "Lead a reading club for teenagers.",
                            EndDate = new DateTime(2025, 7, 23, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3638),
                            Image = "reading-club.png",
                            IsDeleted = false,
                            Location = "Assiut",
                            OrganizationID = "org-user-1",
                            RequiredVolunteers = 5,
                            StartDate = new DateTime(2025, 7, 3, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3637),
                            Status = 1,
                        ...
                        new
                        {
                            Id = "opp-3",
                            CategoryID = "cat-1",
                            CreatedAt = new DateTime(2025, 6, 28, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3646),
                            Description = "Teach basic coding to children in underserved communities.",
                            EndDate = new DateTime(2025, 7, 18, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3644),
                            Image = "coding-kids.png",
                            IsDeleted = false,
                            Location = "Jeddah",
                            OrganizationID = "org-user-1",
                            RequiredVolunteers = 15,
                            StartDate = new DateTime(2025, 7, 8, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3643),
                            Status = 1,
                            TeamId = "team-1",
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.VolunteerProfile", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "vol-user-1",
                            CreatedAt = new DateTime(2025, 6, 28, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3230),
                        ...
                        {
                            Id = "vol_prof2",
                            CreatedAt = new DateTime(2025, 6, 28, 16, 25, 54, 898, DateTimeKind.Utc).AddTicks(3279),
                            Interests = "[\"Education\",\"Health\"]",
                            IsDeleted = false,
                            IsVerified = false,
                            Rating = 0f,
