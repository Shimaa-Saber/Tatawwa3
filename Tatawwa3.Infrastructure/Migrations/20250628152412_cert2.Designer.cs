...
namespace Tatawwa3.Infrastructure.Migrations
{
    ...
    [Migration("20250628152412_cert2")]
    partial class cert2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            City = "Cairo",
                            ConcurrencyStamp = "557e4965-3b4d-429d-8234-2d9b6cb2a4e4",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(309),
                            ...
                            Role = 1,
                            SecurityStamp = "0f7fdb0a-7cd3-48fe-bde8-c633deacf757",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            City = "Assiut",
                            ConcurrencyStamp = "a9b899bf-b44a-4e35-a0dd-b7635c9245bb",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(585),
                            ...
                            PhoneNumberConfirmed = false,
                            Role = 0,
                            SecurityStamp = "2f3cea87-fc71-401b-b4f4-4e255ca9ca96",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(891),
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.OrganizationProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 28, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(444),
                            IsDeleted = false,
                            IsVerified = true,
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.Team", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Cairo",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(984),
                            CreationDate = new DateTime(2025, 6, 13, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(974),
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.TeamMember", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "member-1",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(1091),
                            IsDeleted = false,
                            JoinDate = new DateTime(2025, 6, 23, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(1088),
                            Role = "Leader",
                            TeamID = "team-1",
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.VolunteerOpportunity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "opp-1",
                            CategoryID = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(1190),
                            Description = "Help young children learn basic English skills.",
                            EndDate = new DateTime(2025, 8, 7, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(1188),
                            Image = "english-teaching.png",
                            IsDeleted = false,
                            Location = "Cairo",
                            OrganizationID = "org-user-1",
                            RequiredVolunteers = 10,
                            StartDate = new DateTime(2025, 7, 8, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(1185),
                            Status = 1,
                        ...
                        new
                        {
                            Id = "opp-2",
                            CategoryID = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(1201),
                            Description = "Lead a reading club for teenagers.",
                            EndDate = new DateTime(2025, 7, 23, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(1198),
                            Image = "reading-club.png",
                            IsDeleted = false,
                            Location = "Assiut",
                            OrganizationID = "org-user-1",
                            RequiredVolunteers = 5,
                            StartDate = new DateTime(2025, 7, 3, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(1197),
                            Status = 1,
                        ...
                        new
                        {
                            Id = "opp-3",
                            CategoryID = "cat-1",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(1209),
                            Description = "Teach basic coding to children in underserved communities.",
                            EndDate = new DateTime(2025, 7, 18, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(1207),
                            Image = "coding-kids.png",
                            IsDeleted = false,
                            Location = "Jeddah",
                            OrganizationID = "org-user-1",
                            RequiredVolunteers = 15,
                            StartDate = new DateTime(2025, 7, 8, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(1205),
                            Status = 1,
                            TeamId = "team-1",
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.VolunteerProfile", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "vol-user-1",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(692),
                        ...
                        {
                            Id = "vol_prof2",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 24, 10, 902, DateTimeKind.Utc).AddTicks(791),
                            Interests = "[\"Education\",\"Health\"]",
                            IsDeleted = false,
                            IsVerified = false,
                            Rating = 0f,
