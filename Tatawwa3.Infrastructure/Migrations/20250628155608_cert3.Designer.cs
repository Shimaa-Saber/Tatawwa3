...
namespace Tatawwa3.Infrastructure.Migrations
{
    ...
    [Migration("20250628155608_cert3")]
    partial class cert3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            City = "Cairo",
                            ConcurrencyStamp = "fd1b41a1-6ec9-4207-a035-6c562cf49db0",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(3985),
                            ...
                            Role = 1,
                            SecurityStamp = "e01d43d0-47dd-4382-85ee-c1e69a5503c2",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            City = "Assiut",
                            ConcurrencyStamp = "457485a5-2e64-49cb-a6bd-617328152aa0",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4095),
                            ...
                            PhoneNumberConfirmed = false,
                            Role = 0,
                            SecurityStamp = "b30ba285-7162-412a-b777-c6d751eb0ae7",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4181),
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.OrganizationProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 28, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4059),
                            IsDeleted = false,
                            IsVerified = true,
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.Team", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Cairo",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4225),
                            CreationDate = new DateTime(2025, 6, 13, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4217),
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.TeamMember", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "member-1",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4288),
                            IsDeleted = false,
                            JoinDate = new DateTime(2025, 6, 23, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4286),
                            Role = "Leader",
                            TeamID = "team-1",
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.VolunteerOpportunity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "opp-1",
                            CategoryID = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4322),
                            Description = "Help young children learn basic English skills.",
                            EndDate = new DateTime(2025, 8, 7, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4321),
                            Image = "english-teaching.png",
                            IsDeleted = false,
                            Location = "Cairo",
                            OrganizationID = "org-user-1",
                            RequiredVolunteers = 10,
                            StartDate = new DateTime(2025, 7, 8, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4320),
                            Status = 1,
                        ...
                        new
                        {
                            Id = "opp-2",
                            CategoryID = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4327),
                            Description = "Lead a reading club for teenagers.",
                            EndDate = new DateTime(2025, 7, 23, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4326),
                            Image = "reading-club.png",
                            IsDeleted = false,
                            Location = "Assiut",
                            OrganizationID = "org-user-1",
                            RequiredVolunteers = 5,
                            StartDate = new DateTime(2025, 7, 3, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4325),
                            Status = 1,
                        ...
                        new
                        {
                            Id = "opp-3",
                            CategoryID = "cat-1",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4330),
                            Description = "Teach basic coding to children in underserved communities.",
                            EndDate = new DateTime(2025, 7, 18, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4329),
                            Image = "coding-kids.png",
                            IsDeleted = false,
                            Location = "Jeddah",
                            OrganizationID = "org-user-1",
                            RequiredVolunteers = 15,
                            StartDate = new DateTime(2025, 7, 8, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4328),
                            Status = 1,
                            TeamId = "team-1",
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.VolunteerProfile", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "vol-user-1",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4129),
                        ...
                        {
                            Id = "vol_prof2",
                            CreatedAt = new DateTime(2025, 6, 28, 15, 56, 7, 554, DateTimeKind.Utc).AddTicks(4156),
                            Interests = "[\"Education\",\"Health\"]",
                            IsDeleted = false,
                            IsVerified = false,
                            Rating = 0f,
