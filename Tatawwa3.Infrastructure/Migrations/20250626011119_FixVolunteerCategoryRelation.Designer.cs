...
namespace Tatawwa3.Infrastructure.Migrations
{
    ...
    [Migration("20250626011119_FixVolunteerCategoryRelation")]
    partial class FixVolunteerCategoryRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            City = "Cairo",
                            ConcurrencyStamp = "d48822c1-5444-4265-97ec-956e86475439",
                            CreatedAt = new DateTime(2025, 6, 26, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3261),
                            ...
                            Role = 1,
                            SecurityStamp = "d0b7de77-4680-4ee4-9ff8-7a726cc14731",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            City = "Assiut",
                            ConcurrencyStamp = "757b6c2e-90b7-4a91-b3f7-080990fd1209",
                            CreatedAt = new DateTime(2025, 6, 26, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3366),
                            ...
                            PhoneNumberConfirmed = false,
                            Role = 0,
                            SecurityStamp = "a14af87b-5660-4972-bdec-8060b35ee37f",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 26, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3453),
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.OrganizationProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 26, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3321),
                            IsDeleted = false,
                            IsVerified = true,
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.Team", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Cairo",
                            CreatedAt = new DateTime(2025, 6, 26, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3496),
                            CreationDate = new DateTime(2025, 6, 11, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3486),
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.TeamMember", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "member-1",
                            CreatedAt = new DateTime(2025, 6, 26, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3531),
                            IsDeleted = false,
                            JoinDate = new DateTime(2025, 6, 21, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3529),
                            Role = "Leader",
                            TeamID = "team-1",
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.VolunteerOpportunity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "opp-1",
                            CategoryID = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 26, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3568),
                            Description = "Help young children learn basic English skills.",
                            EndDate = new DateTime(2025, 8, 5, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3563),
                            Image = "english-teaching.png",
                            IsDeleted = false,
                            Location = "Cairo",
                            OrganizationID = "org-user-1",
                            RequiredVolunteers = 10,
                            StartDate = new DateTime(2025, 7, 6, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3562),
                            Status = 1,
                        ...
                        new
                        {
                            Id = "opp-2",
                            CategoryID = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 26, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3572),
                            Description = "Lead a reading club for teenagers.",
                            EndDate = new DateTime(2025, 7, 21, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3571),
                            Image = "reading-club.png",
                            IsDeleted = false,
                            Location = "Assiut",
                            OrganizationID = "org-user-1",
                            RequiredVolunteers = 5,
                            StartDate = new DateTime(2025, 7, 1, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3570),
                            Status = 1,
                        ...
                        new
                        {
                            Id = "opp-3",
                            CategoryID = "cat-1",
                            CreatedAt = new DateTime(2025, 6, 26, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3576),
                            Description = "Teach basic coding to children in underserved communities.",
                            EndDate = new DateTime(2025, 7, 16, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3574),
                            Image = "coding-kids.png",
                            IsDeleted = false,
                            Location = "Jeddah",
                            OrganizationID = "org-user-1",
                            RequiredVolunteers = 15,
                            StartDate = new DateTime(2025, 7, 6, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3574),
                            Status = 1,
                            TeamId = "team-1",
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.VolunteerProfile", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "vol-user-1",
                            CreatedAt = new DateTime(2025, 6, 26, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3402),
                        ...
                        {
                            Id = "vol_prof2",
                            CreatedAt = new DateTime(2025, 6, 26, 1, 11, 18, 307, DateTimeKind.Utc).AddTicks(3426),
                            Interests = "[\"Education\",\"Health\"]",
                            IsDeleted = false,
                            IsVerified = false,
                            Rating = 0f,
