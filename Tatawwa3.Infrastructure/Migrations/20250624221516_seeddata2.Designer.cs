...
namespace Tatawwa3.Infrastructure.Migrations
{
    ...
    [Migration("20250624221516_seeddata2")]
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            City = "Cairo",
                            ConcurrencyStamp = "d0651826-f074-4599-9369-ca86eeb91992",
                            CreatedAt = new DateTime(2025, 6, 24, 22, 15, 15, 975, DateTimeKind.Utc).AddTicks(1676),
                            ...
                            Role = 1,
                            SecurityStamp = "1fe91c29-0224-4905-acf9-bcd31d119017",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            City = "Assiut",
                            ConcurrencyStamp = "5a98cba5-e86f-4b2d-8103-7092158bdf5f",
                            CreatedAt = new DateTime(2025, 6, 24, 22, 15, 15, 975, DateTimeKind.Utc).AddTicks(1776),
                            ...
                            PhoneNumberConfirmed = false,
                            Role = 0,
                            SecurityStamp = "ee0411d3-3eec-4666-8069-e1b9293ad615",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "cat-edu-1",
                            CreatedAt = new DateTime(2025, 6, 24, 22, 15, 15, 975, DateTimeKind.Utc).AddTicks(1894),
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.OrganizationProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 24, 22, 15, 15, 975, DateTimeKind.Utc).AddTicks(1746),
                            IsDeleted = false,
                            IsVerified = true,
            ...
            modelBuilder.Entity("Tatawwa3.Domain.Entities.VolunteerProfile", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "vol-user-1",
                            CreatedAt = new DateTime(2025, 6, 24, 22, 15, 15, 975, DateTimeKind.Utc).AddTicks(1860),
