...
{
    public class GetAllReviewsTableHandler : IRequestHandler<GetAllReviewsTableQuery, List<ReviewTableDto>>
    {
        private readonly IReviewRepository _reviewRepository;
        private readonly IUserRepository _userRepository;

        public GetAllReviewsTableHandler(IReviewRepository reviewRepository, IUserRepository userRepository)
        {
            _reviewRepository = reviewRepository;
            _userRepository = userRepository;
        }

        public async Task<List<ReviewTableDto>> Handle(GetAllReviewsTableQuery request, CancellationToken cancellationToken)
        {
