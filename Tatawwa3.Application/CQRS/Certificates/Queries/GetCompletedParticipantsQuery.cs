...
{
    public record GetCompletedParticipantsQuery(string OrgId) : IRequest<List<CompletedParticipantDto>>;
    ...
    public class GetCompletedParticipantsHandler : IRequestHandler<GetCompletedParticipantsQuery, List<CompletedParticipantDto>>
    {
        ...
        {
            return await _certificateService.GetCompletedParticipantsForOrganizationAsync(request.OrgId);
        }
    }
